...
- Description: Converts an xliff file to an tmx file.
- Requirement: [`tmxkit`](https://github.com/ikuehirata/tmxkit).
- Expected benefit: Processed xliffs can be directly imported to TM.
- Directory: [examples/04_convert_to_tmx](../examples/04_convert_to_tmx)
